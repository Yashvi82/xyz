...
PATH = "templates" # your project path
POPPLER_PATH = "C://Program Files//Common Files//poppler-23.08.0//Library//bin" # your poppler bin path
...
def upload_gseb():
    if request.method == "POST":
        ...
        if file and allowed_file(file.filename):
            ...
            with open(f"static/data.json", 'w') as file:
